 ...
 * 
 */
@WebServiceClient(name = "BanqueService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/BanqueService/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/BanqueService/?wsdl");
